...
const getSvgProps = (title: string) => ({ title, xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink', preserveAspectRatio: 'xMidYMid meet' });
type IconRenderer = ({ color, size, title }: { color: string, size: number, title: string }) => JSX.Element;
const icons: Record<string, IconRenderer> = {
  logo: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 1484.32 1348.5">
  ...
  loading: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  menu: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
               <path d="M4 6h16M4 12h16M4 18h16" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>),
  close: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  download: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  trash: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  edit: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 1024 1024">
  ...
  check: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
               <g fill="none"><path d="M8.818 19.779l-6.364-6.364l2.83-2.83l3.534 3.544l9.898-9.908l2.83 2.83L8.818 19.779z" fill={color} /></g>
            </svg>),
  error: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 36 36">
  ...
  question: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  'caret-left': ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 256">
  ...
  'caret-right': ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 256">
  ...
  'caret-down': ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 256">
  ...
  'caret-up': ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 256">
  ...
  search: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 1024 1024">
  ...
  settings: ({ color, size, title }) => (<svg width={size} viewBox="0 0 16 16" {...getSvgProps(title)}>
  ...
  'settings-alt': ({ color, size, title }) => (<svg width={size} viewBox="0 0 32 32" {...getSvgProps(title)}>
  ...
  logout: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
  ...
  reload: ({ color, size, title }) => (<svg width={size} viewBox="0 0 344 480" {...getSvgProps(title)}>
  ...
  dots: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
  ...
  hamburger: ({ color, size, title }) => (<svg width={size} viewBox="0 0 15 15" {...getSvgProps(title)}>
               <g fill="none">
  ...
  star: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
  ...
  'star-filled': ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
                  <path fill={color} d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.62L12 2L9.19 8.62L2 9.24l5.45 4.73L5.82 21z"></path>
               </svg>),
  link: ({ color, size, title }) => (<svg width={size} viewBox="0 0 20 20" {...getSvgProps(title)}>
  ...
  'link-alt': ({ color, size, title }) => (<svg width={size} viewBox="0 0 20 20" {...getSvgProps(title)}>
               <g fill="none">
  ...
  clock: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
  ...
  sort: ({ color, size, title }) => (<svg width={size} viewBox="0 0 48 48" {...getSvgProps(title)}>
  ...
  desktop: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
  ...
  mobile: ({ color, size, title }) => (<svg width={size} viewBox="0 0 24 24" {...getSvgProps(title)}>
               <g fill="none">
  ...
  tags: ({ color, size, title }) => (<svg width={size} viewBox="0 0 1920 1536" {...getSvgProps(title)}>
  ...
  filter: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  idea: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  tracking: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  google: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 262">
  ...
  adwords: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 256 256">
                  <g>
  ...
  keywords: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
                  <path fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 12h14M5 16h6"></path>
               </svg>),
  integration: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  cursor: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
                  <path fill="none" stroke={color} strokeWidth="2" d="M6 3l12 11l-5 1l3 5.5l-3 1.5l-3-6l-4 3z"/>
               </svg>),
  eye: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
                  <g fill="none">
  ...
  'eye-closed': ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  target: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  help: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  date: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  email: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
  ...
  scraper: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 16 16">
  ...
  city: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 48 48">
                  <g fill="none">
  ...
  research: ({ color, size, title }) => (<svg width={size} viewBox="0 0 48 48" {...getSvgProps(title)}>
  ...
  domains: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 56 56">
  ...
  lock: ({ color, size, title }) => (<svg {...getSvgProps(title)} width={size} viewBox="0 0 24 24">
...
const Icon = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }: IconProps) => {
  ...
  return Svg ? (
    <span className={`icon inline-block relative top-[2px] ${classes}`}>
      <Svg color={color} size={size} title={title} />
    </span>
  ) : null;
};
